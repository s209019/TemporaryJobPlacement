...
public class ShowMessageActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AsyncTask<Object, Object, Object>(){
            ...
            protected Object doInBackground(Object... params) {
                try {
                    message[0] = Message.getQuery().include("student").include("originalMessage").get(messageId);
                } catch (Exception e) {
                    e.printStackTrace();
                    return null;
                }
    ...
    private void initializeView(final Message message) {
        ...
        getSupportActionBar().setSubtitle(message.getStudent().getFirstName()+" "+message.getStudent().getLastName());
        ...
        companyStudentTextView.setText(message.getStudent().getFirstName()+" "+message.getStudent().getLastName());

        companyStudentTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent detailIntent = new Intent(ShowMessageActivity.this, CompanyDetailActivity.class);
                detailIntent.putExtra("SELECTED_STUDENT", message.getStudent().getObjectId());
    ...
    public void reply(View v) {
        try {
            ...
            intent.putExtra("SELECTED_STUDENT", message.getStudent().getObjectId());
