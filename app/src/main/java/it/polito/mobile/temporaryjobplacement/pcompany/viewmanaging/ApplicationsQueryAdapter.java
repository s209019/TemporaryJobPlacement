...
public class ApplicationsQueryAdapter extends ParseQueryAdapter<Application> {
    ...
    public View getItemView(final Application application, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(getContext(), R.layout.application_list_item_for_company, null);
        }
        ...
        titleTextView.setText(application.getStudent().getLastName().toUpperCase(Locale.ENGLISH)+" "+application.getStudent().getFirstName().toUpperCase(Locale.ENGLISH));
