...
/* Copyright 2014 Google Inc. All rights reserved.
        ...
        */
        ...
        package it.polito.mobile.temporaryjobplacement.commons.viewmanaging.googlelibtabview;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int mDefaultTabViewTextColor =-1;
    ...
    public void setCustomTabColorizer(TabColorizer tabColorizer) {
        ...
        mDefaultTabViewTextColor=tabColorizer.getDefaultTextColor();
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextColor(mDefaultTabViewTextColor);
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i == mViewPager.getCurrentItem()) {
                ...
                if(mTabColorizer!=null)
                    ((TextView)mTabStrip.getChildAt(i)).setTextColor(mTabColorizer.getIndicatorColor(i));
            }
        }
    }
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                if(position==i){
                    ...
                    if(mTabColorizer!=null)
                    ((TextView)mTabStrip.getChildAt(i)).setTextColor(mTabColorizer.getIndicatorColor(position));
                }else{
                    ((TextView)mTabStrip.getChildAt(i)).setTextColor(mDefaultTabViewTextColor);
                }
            }
            if (mViewPagerPageChangeListener != null) {
